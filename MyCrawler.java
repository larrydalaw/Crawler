...
public class MyCrawler extends WebCrawler {
	...
	private static final Pattern FILTERS = Pattern.compile(
   	        ...
   	        "|rm|smil|wmv|swf|wma|zip|rar|gz|xml|rss))$");
			 ...
			 */
			 ...
			 public boolean shouldVisit(Page referringPage, WebURL url) {
				 ...
				 FileWriter pw;
					try {
						File f=new File("/Users/shraddharavishankar/Documents/USC Notes/IR/data/excelfiles/urls_LA_times.csv");
						if(f.exists()){
			...
			/*try {
			  ...
			  try {
					File f=new File("/Users/shraddharavishankar/Documents/USC Notes/IR/data/excelfiles/visit_LA_times.csv");
					if(f.exists()){
						pw = new FileWriter(f.getAbsoluteFile(),true);
						StringBuilder sb = new StringBuilder();
			...
			private static void countVisited() {
				// TODO Auto-generated method stub
				visited++;
